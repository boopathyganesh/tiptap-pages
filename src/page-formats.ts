...
export interface PageFormat {
  name: string;
  width: number;  // Width in pixels at 96 DPI
  height: number; // Height in pixels at 96 DPI
  margins: {
 ...
 */
export function pageFormatToOptions(format: PageFormat | string): Partial<PageOptions> {
 ...
 */
export function getPageFormat(name: string): PageFormat | undefined {
 ...
 */
export function getPageFormatNames(): string[] {
